...
r1_less <- read.table(paste(workdir,"ProR1.ksTest.Less.Significant.MedianTx.GC",sep=""))$V2
r1_greater <- read.table(paste(workdir,"ProR1.ksTest.Greater.Significant.MedianTx.GC",sep=""))$V2
r2_less <- read.table(paste(workdir,"ProR2.ksTest.Less.Significant.MedianTx.GC",sep=""))$V2
r2_greater <- read.table(paste(workdir,"ProR2.ksTest.Greater.Significant.MedianTx.GC",sep=""))$V2
